                    ...
                    ZStack {
                        ...
                        Text("وجه متفاجئ")
                            ...
                            .onTapGesture {
                                ...
                                if isImage1Select && isText1Select{
                                    is1True = true
                                    framColor1 = .green
                                    is1Desabeled = true
                                    isSelectSomeThing.toggle()
                                }else if isImage2Select && isText1Select {
                                    is1True = false
                                    framColor1 = .red
                                }else {
                                    framColor1 = .gray
                    ...
                    ZStack {
                        ...
                        Text("وجه خجول")
                            ...
                            .onTapGesture {
                                ...
                                if isImage2Select && isText2Select{
                                    is2True = true
                                    framColor2 = .green
                                    is2Desabeled = true
                                    isSelectSomeThing.toggle()
                                }else if isImage1Select && isText2Select {
                                    is2True = false
                                    framColor2 = .red
                                }else {
                                    framColor2 = .gray
...
//MARK: end
               ...
               Spacer()
                Button {
                    env.num += 1
                    activityStatus.Status.setLevel_5()
                } label: {
                    Text("ارسال")
...
//struct face5gView_Previews: PreviewProvider {
